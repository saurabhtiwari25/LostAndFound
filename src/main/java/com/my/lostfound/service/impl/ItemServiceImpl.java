...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public Page<ItemResponseDto> getAllItems(int page, int size, String sortBy, String direction) {
    ...
    public List<ItemResponseDto> searchByTitle(String keyword) {
        ...
        return itemRepository.findByTitleContainingIgnoreCaseAndDeletedFalse(keyword)
                .stream()
                .map(this::mapToDTO)
    ...
    public List<ItemResponseDto> filterItems(String location, boolean found) {
        log.info("Filtering items by location '{}' and found={}", location, found);
        return itemRepository.findByLocationAndFoundAndDeletedFalse(location, found)
                .stream()
                .map(this::mapToDTO)
                .collect(Collectors.toList());
    }
    ...
    private ItemResponseDto mapToDTO(Item item) {
        return ItemResponseDto.builder()
                ...
                .updatedAt(item.getUpdatedAt()) // added updatedAt
                .build();
    }
}